...
import employee.service.crud.controller.enums.EmployeeColumns;
...
public class EmployeeController {
    ...
    private Department addDepartmentToEmployee() throws SQLException {
        ...
        Department department = departmentController.searchByTitle(title);
        System.out.println(department);
        if (department == null) {
            return departmentController.addDepartment();
        } else {
            return (department);
        }
    }
    ...
    private Address addAddressToEmployee() throws SQLException {
        ...
        Address address = addressController.getById(id);
        if (address == null) {
            return addressController.addAddress();
        } else {
            return address;
        }
    }
    ...
    public void deleteEmployee() throws SQLException {
        String inn = InputValue.inputINN();
        Employee employee = searchByINN(inn);
        if (employee != null) {
    ...
    public void editeEmployee() throws SQLException {
        ...
        Employee employee = searchByINN(inn);
        if (employee != null) {
            handleChoiceNameTable(employee);
    ...
    private void handleChoiceNameTable(Employee employee) throws SQLException {
        String n = "N";
    ...
    public Employee searchByINN(String str) throws SQLException {
