...
import static employee.service.crud.controller.enums.Actions.*;
import static employee.service.crud.controller.enums.AddressColumns.*;
import static employee.service.crud.controller.enums.EmployeeColumns.*;
import static employee.service.crud.controller.enums.Models.*;
...
public class InputValue {
    ...
    public static Models inputEntity() {
        try {
            System.out.println("Input the item from the list: "
                    + ADDRESS + ", "
                    + EMPLOYEE + ", "
                    + DEPARTMENT);
            Models item = Models.valueOf(READER.readLine());
